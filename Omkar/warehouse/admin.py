...
class PropertyAdmin(admin.ModelAdmin):
    ...
    list_display = ['uid','company','property_name','admin_created_at','admin_updated_at']
    class Meta:
        model = Property
...
class GalaAdmin(admin.ModelAdmin):
    ...
    list_display = ['uid','warehouse','gala_number','admin_created_at','admin_updated_at','is_allotted']
    class Meta:
        model = Gala
